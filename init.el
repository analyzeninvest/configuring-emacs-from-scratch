...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (typing-game anaconda-mode typing multiple-cursors csv-mode tj3-mode which-key ialign org-pdfview pdfgrep pdf-tools command-log-mode expand-region org-plus-contrib langtool flycheck flyspell-correct-ivy highlight-indent-guides yasnippet-snippets company-anaconda trr yasnippet company-quickhelp company paredit iedit magit counsel-projectile counsel ivy org-bullets cycle-themes dracula-theme exotica-theme ido-grid-mode ido-describe-bindings))))
(custom-set-faces
